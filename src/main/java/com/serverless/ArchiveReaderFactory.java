 ...
 */
public class ArchiveReaderFactory extends WebArchiveReaderFactory implements org.archive.format.warc.WARCConstants
{
  private static final ArchiveReaderFactory factory = new ArchiveReaderFactory();
  ...
  {
    return (WARCReader) ArchiveReaderFactory.factory.getArchiveReader(arcFileOrUrl);
  }

  public static WARCReader get(final File f) throws IOException
  {
    return (WARCReader) ArchiveReaderFactory.factory.getArchiveReader(f);
  }
   ...
   * @throws IOException
   */
  public static WARCReader get(final File f, final long offset) throws IOException
  {
    return (WARCReader) ArchiveReaderFactory.factory.getArchiveReader(f, offset);
  }
  ...
  protected ArchiveReader getArchiveReader(final File f, final long offset) throws IOException
  {
    ...
    if (!compressed)
    {
      if (!FileUtils.isReadableWithExtensionAndMagic(f, DOT_WARC_FILE_EXTENSION, WARC_MAGIC))
      {
        throw new IOException(f.getAbsolutePath() + " is not a WARC file.");
      }
    }

    return (WARCReader) (compressed ? ArchiveReaderFactory.factory.new CompressedWARCReader(f, offset)
        : ArchiveReaderFactory.factory.new UncompressedWARCReader(f, offset));
  }

  public static ArchiveReader get(final String s, final InputStream is, final boolean atFirstRecord) throws IOException
  {
    return ArchiveReaderFactory.factory.getArchiveReader(s, is, atFirstRecord);
  }
   ...
   */
  protected ArchiveReader getArchiveReader(final String f, final InputStream is, final boolean atFirstRecord) throws IOException
  {
  ...
  public static WARCReader get(final URL arcUrl, final long offset) throws IOException
  {
    return (WARCReader) ArchiveReaderFactory.factory.getArchiveReader(arcUrl, offset);
  }
   ...
   * @throws IOException
   */
  public static WARCReader get(final URL arcUrl) throws IOException
  {
    return (WARCReader) ArchiveReaderFactory.factory.getArchiveReader(arcUrl);
  }
   ...
   */
  public static boolean testCompressedWARCFile(final File f) throws IOException
  {
  ...
  public class UncompressedWARCReader extends WARCReader
  {
     ...
     * @throws IOException
     */
    public UncompressedWARCReader(final File f) throws IOException
    {
      this(f, 0);
    }
     ...
     * @throws IOException
     */
    public UncompressedWARCReader(final File f, final long offset) throws IOException
    {
  ...
  public class CompressedWARCReader extends WARCReader
  {
     ...
     * @throws IOException
     */
    public CompressedWARCReader(final File f, final long offset) throws IOException
    {
      // File has been tested for existence by time it has come to here.
     ...
     * @throws IOException
     */
    public CompressedWARCReader(final String f, final InputStream is, final boolean atFirstRecord) throws IOException
    {
      // Arc file has been tested for existence by time it has come
      // to here.
  ...
  {
    return (f == null) ? false : (f.toLowerCase().endsWith(DOT_COMPRESSED_WARC_FILE_EXTENSION)) ? true : (f.toLowerCase()
        .endsWith(DOT_WARC_FILE_EXTENSION)) ? true : false;
  }
}